...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("Command: docker {}", basic_example.build_args().join(" "));
    ...
    println!(
        "Command: docker {}",
        resource_example.build_args().join(" ")
    );
    ...
    println!(
        "Command: docker {}",
        security_example.build_args().join(" ")
    );
    ...
    println!("Command: docker {}", network_example.build_args().join(" "));
    ...
    println!("Command: docker {}", storage_example.build_args().join(" "));
    ...
    println!("Command: docker {}", env_example.build_args().join(" "));
    ...
    println!("Command: docker {}", health_example.build_args().join(" "));
    ...
    println!("Command: docker {}", logging_example.build_args().join(" "));
    ...
    println!("Command: docker {}", gpu_example.build_args().join(" "));
    ...
    println!(
        "Command: docker {}",
        enterprise_example.build_args().join(" ")
    );
