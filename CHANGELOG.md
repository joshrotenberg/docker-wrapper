...
## [0.8.2](https://github.com/joshrotenberg/docker-wrapper/compare/v0.8.1...v0.8.2) - 2025-08-27

### Fixed

- enable all features for docs.rs to show template documentation ([#159](https://github.com/joshrotenberg/docker-wrapper/pull/159))

## [0.8.1](https://github.com/joshrotenberg/docker-wrapper/compare/v0.8.0...v0.8.1) - 2025-08-27

### Other

- comprehensive template documentation and integration tests ([#157](https://github.com/joshrotenberg/docker-wrapper/pull/157))

## [0.8.0](https://github.com/joshrotenberg/docker-wrapper/compare/v0.7.0...v0.8.0) - 2025-08-26

### Added

- [**breaking**] replace curl with reqwest for Redis Enterprise bootstrap ([#155](https://github.com/joshrotenberg/docker-wrapper/pull/155))

### Other

- clarify DockerCommand trait requirement and fix ContainerId usage ([#154](https://github.com/joshrotenberg/docker-wrapper/pull/154))
